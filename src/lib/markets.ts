import { publicBetaCopy } from "@/i18n/public-beta";
...
const EN_HELPS = [
  ...
  publicBetaCopy.en["publicBeta.preparePublishingToYourWebsite"],
...
const EN_JOURNEY = [
  {
    week: "Week 1",
    items: ["Free audit", "Project setup", "Brand Intelligence", "Tracking check"],
  },
  {
    week: "Week 2",
    items: [
      publicBetaCopy.en["publicBeta.contentPrioritiesInPlan"],
      "Content plan",
      "Milo Score baseline",
    ],
  },
  {
    week: "Week 3",
    items: [
      publicBetaCopy.en["publicBeta.draftReviewContent"],
      "Authority tasks",
      publicBetaCopy.en["publicBeta.connectorSetupIfPossible"],
    ],
  },
  {
    week: "Week 4",
    items: ["Analytics & GSC review", "Next actions", "Handover or monthly support"],
  },
];
const EN_TRUST_REVIEW =
  "Milo is AI-assisted. Content should be reviewed before publishing, especially claims, pricing, legal, medical, financial or regulated information.";
...
export const MARKETS: Record<DisplayRegion, MarketConfig> = {
  pl: {
    ...
    metaDescription:
      "Milo Growth pomaga małym firmom w Polsce planować, tworzyć, publikować i mierzyć wzrost strony — z pomocą AI i kontrolą człowieka.",
    ...
    positioning:
      "Milo Growth pomaga małym firmom uporządkować widoczność strony, treści, publikację i mierzenie efektów — bez obietnic magicznego SEO.",
    ctaAudit: "Zrób darmowy audit AI visibility",
    ctaBeta: "Zgłoś firmę do beta",
    availabilityNote:
      publicBetaCopy.pl["publicBeta.pilotAvailabilityAndScopeAreAgreedIndividually"],
    ...
    helps: [
      ...
      publicBetaCopy.pl["publicBeta.preparePublishingToYourWebsite"],
    ...
    journey: [
      ...
      },
      {
        week: "Tydzień 2",
        items: [
          publicBetaCopy.pl["publicBeta.contentPrioritiesInPlan"],
          "Plan treści",
          "Bazowy Milo Score",
        ],
      },
      {
        week: "Tydzień 3",
        items: [
          publicBetaCopy.pl["publicBeta.draftReviewContent"],
          "Zadania autorytetu",
          publicBetaCopy.pl["publicBeta.connectorSetupIfPossible"],
        ],
      },
      {
        week: "Tydzień 4",
        items: [
          "Przegląd Analytics i GSC",
          "Następne kroki",
          "Przekazanie lub wsparcie miesięczne",
        ],
      },
    ],
    ...
    whoFor: [
      "Salony beauty/wellness",
      "Gabinety i masażyści",
      "Konsultanci",
      "Lokalne usługi",
      "Małe sklepy internetowe",
    ],
    eligibility:
      "Ceny pokazane na tej stronie dotyczą firm rozliczanych w Polsce. Zmiana języka lub regionu nie zmienia kwalifikacji do rozliczeń. Finalna cena może zależeć od kraju firmy, danych do rozliczeń, wielkości strony, konfiguracji konektora i poziomu wsparcia.",
    trustReview:
      "Milo działa z pomocą AI. Treść należy sprawdzić przed publikacją — zwłaszcza twierdzenia, ceny oraz kwestie prawne, medyczne, finansowe i regulowane.",
    trustNoGuarantee:
      "Milo nie gwarantuje pozycji, ruchu, przychodów ani cytowań w narzędziach AI.",
    applyHeading: "Zgłoś firmę do Assisted Beta",
    applyBody:
      "Zacznij od darmowego auditu lub napisz do nas, aby się zgłosić. Liczba miejsc jest ograniczona.",
    moreHeading: "Więcej",
  },
  se: {
    region: "se",
    ...
    metaDescription:
      "Milo Growth hjälper småföretag i Sverige att planera, skapa, publicera och mäta webbplatstillväxt — med AI-stöd och mänsklig kontroll.",
    heroTitle: "Milo Growth för svenska företag",
    heroSubtitle:
      "En guidad 30-dagars uppstart för att planera, skapa, publicera och mäta webbplatstillväxt.",
    positioning:
      "Milo Growth hjälper småföretag i Sverige att planera, skapa, publicera och mäta webbplatstillväxt — med AI-stöd och mänsklig kontroll.",
    ctaAudit: "Gör en gratis AI visibility audit",
    ctaBeta: "Ansök till beta",
    availabilityNote:
      publicBetaCopy.sv["publicBeta.pilotAvailabilityAndScopeAreAgreedIndividually"],
    ...
    helps: [
      ...
      publicBetaCopy.sv["publicBeta.preparePublishingToYourWebsite"],
    ...
    journey: [
      ...
      },
      {
        week: "Vecka 2",
        items: [
          publicBetaCopy.sv["publicBeta.contentPrioritiesInPlan"],
          "Innehållsplan",
          "Milo Score-baslinje",
        ],
      },
      {
        week: "Vecka 3",
        items: [
          publicBetaCopy.sv["publicBeta.draftReviewContent"],
          "Auktoritetsuppgifter",
          publicBetaCopy.sv["publicBeta.connectorSetupIfPossible"],
        ],
      },
      {
        week: "Vecka 4",
        items: ["Analys- & GSC-genomgång", "Nästa steg", "Överlämning eller månadsstöd"],
      },
    ],
    ...
    eligibility:
      "Priserna som visas gäller företag som faktureras i Sverige. Att byta visningsregion eller språk ändrar inte faktureringsbehörigheten. Slutpriset kan bero på företagets land, faktureringsuppgifter, webbplatsens storlek, kopplaruppsättning och supportnivå.",
    trustReview:
      "Milo är AI-assisterat. Innehåll bör granskas före publicering — särskilt påståenden, priser samt juridisk, medicinsk, ekonomisk eller reglerad information.",
    ...
    applyBody:
      "Börja med en gratis granskning eller hör av dig för att ansöka. Platserna är begränsade.",
    moreHeading: "Mer",
  },
  dk: {
    region: "dk",
    ...
    metaDescription:
      "Milo Growth hjælper små virksomheder i Danmark med at planlægge, skabe, publicere og måle vækst på deres website — med AI-assistance og menneskelig kontrol.",
    heroTitle: "Milo Growth for danske virksomheder",
    heroSubtitle:
      "En guidet 30-dages opsætning til at planlægge, skabe, publicere og måle webvækst.",
    positioning:
      "Milo Growth hjælper små virksomheder i Danmark med at planlægge, skabe, publicere og måle vækst på deres website — med AI-assistance og menneskelig kontrol.",
    ctaAudit: "Lav et gratis AI visibility-tjek",
    ctaBeta: "Ansøg til beta",
    availabilityNote:
      publicBetaCopy.da["publicBeta.pilotAvailabilityAndScopeAreAgreedIndividually"],
    ...
    helps: [
      ...
      publicBetaCopy.da["publicBeta.preparePublishingToYourWebsite"],
    ...
    journey: [
      {
        week: "Uge 1",
        items: ["Gratis tjek", "Projektopsætning", "Brandintelligens", "Sporingstjek"],
      },
      {
        week: "Uge 2",
        items: [
          publicBetaCopy.da["publicBeta.contentPrioritiesInPlan"],
          "Indholdsplan",
          "Milo Score-baseline",
        ],
      },
      {
        week: "Uge 3",
        items: [
          publicBetaCopy.da["publicBeta.draftReviewContent"],
          "Autoritetsopgaver",
          publicBetaCopy.da["publicBeta.connectorSetupIfPossible"],
        ],
      },
      {
        week: "Uge 4",
        items: [
          "Analytics- & GSC-gennemgang",
          "Næste skridt",
          "Overdragelse eller månedlig support",
        ],
      },
    ],
    pricingHeading: "Betapriser",
    ...
    eligibility:
      "De viste priser gælder virksomheder, der faktureres i Danmark. At skifte visningsregion eller sprog ændrer ikke faktureringsberettigelsen. Den endelige pris kan afhænge af virksomhedens land, faktureringsoplysninger, webstedets størrelse, forbindelsesopsætning og supportniveau.",
    trustReview:
      "Milo er AI-assisteret. Indhold bør gennemgås før udgivelse — især påstande, priser samt juridiske, medicinske, finansielle eller regulerede oplysninger.",
  ...
  uk: {
    ...
    metaDescription:
      "Milo Growth helps UK small businesses turn website gaps into better content, safer authority tasks, publishing workflows and measurable growth signals.",
    ...
    availabilityNote:
      publicBetaCopy.en["publicBeta.pilotAvailabilityAndScopeAreAgreedIndividually"],
    ...
    whoFor: [
      ...
      "Wellness, beauty and clinics",
      "Consultants",
      "Small e-commerce brands",
      "Professional services",
    ],
    eligibility:
      "Pricing shown is for businesses billed in the United Kingdom. Changing display region or language does not change billing eligibility. If your business is billed elsewhere, local or EU pricing may apply. Final pricing may depend on business country, billing details, website size, connector setup and support level.",
  ...
  eu: {
    ...
    metaDescription:
      "Milo Growth helps European small businesses plan, create, publish and measure website growth with AI-assisted workflows and human review.",
    ...
    eligibility:
      "Generic EU pricing applies to businesses outside listed local markets or where no local pricing is available. Changing display region or language does not change billing eligibility. Final pricing may depend on business country, website size, connector setup and support level.",
    trustReview: EN_TRUST_REVIEW,
    trustNoGuarantee: EN_TRUST_NOGUARANTEE,
    applyHeading: "Apply for the Assisted Beta",
    applyBody: "Start with a free audit, or get in touch to apply. Beta places are limited.",
...
export function regionToBillingMarket(
  region: DisplayRegion,
): "Poland" | "Sweden" | "Denmark" | "United Kingdom" | "European Union" {
 ...
 */
export function suggestDisplayRegion(signals: {
  timeZone?: string;
  language?: string;
}): DisplayRegion {
