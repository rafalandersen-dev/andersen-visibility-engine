    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <article className="mx-auto max-w-3xl px-6 py-16 prose prose-neutral dark:prose-invert">
        ...
        <p className="mt-4 text-lg text-foreground/80">
          If you run a clinic, salon, studio, contracting business or any other small service
          company, local SEO is the single highest-leverage marketing channel you have. This guide
          walks through a practical local SEO strategy you can execute yourself — without an agency
          retainer.
        </p>
        ...
        <ul className="mt-3 space-y-2 text-foreground/85 list-disc pl-6">
          <li>
            Claim and verify the profile with the exact legal business name — no keyword stuffing.
          </li>
          <li>
            Pick the most specific primary category, then add secondary categories for each service.
          </li>
          <li>
            Fill every field: hours, service area, phone, website, attributes and a complete
            description.
          </li>
        ...
        <p className="mt-3 text-foreground/85">
          Your local keyword strategy is the intersection of three things: the services you sell,
          the places you serve, and how people actually phrase their searches. Start with one page
          per service and one page per city or neighbourhood you want to win.
        </p>
        <ul className="mt-3 space-y-2 text-foreground/85 list-disc pl-6">
          <li>
            <strong>Service pages:</strong> "[service] in [city]" — e.g. "emergency plumber in
            Bristol".
          </li>
          <li>
            <strong>Comparison pages:</strong> "[service A] vs [service B]" for buyers narrowing
            options.
          </li>
          <li>
            <strong>Informational pages:</strong> "how much does [service] cost in [city]" or "what
            to expect".
          </li>
        </ul>
        ...
        <p className="mt-3 text-foreground/85">
          ...
          routine: send a short message with a direct review link within 24 hours of the job.
          Respond to every review, positive or negative, in your own voice. Aim for steady flow
          rather than a big burst.
        </p>
        ...
        <p className="mt-3 text-foreground/85">
          Local SEO compounds. One new service page, one new location page, one new FAQ block, one
          new customer story per month — multiplied over a year — usually beats a one-off "SEO
          project". This is exactly the rhythm Milo Growth helps small business owners maintain
        ...
        <div className="mt-12 rounded-xl border border-border bg-card p-6">
          ...
          <div className="mt-4">
            <Button asChild>
              <Link to="/auth">Start free preview</Link>
            </Button>
          </div>
        </div>
      </article>
