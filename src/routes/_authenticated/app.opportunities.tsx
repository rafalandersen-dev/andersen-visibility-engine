...
import type { ContentType, Language, OpportunityStatus, Priority } from "@/lib/types";
...
export const Route = createFileRoute("/_authenticated/app/opportunities")({
  beforeLoad: () => {
    throw redirect({
      to: "/app/plan",
      search: { view: "discover", scale: "week", selected: undefined },
    });
  },
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "AI-generated visibility opportunities ranked by business value.",
      },
    ],
  }),
    ...
    >
      <div className="flex flex-wrap gap-2 mb-6">
        ...
        <Filter
          ...
          value={fStatus}
          onChange={setFStatus}
          options={["New", "In Brief", "Drafting", "Discarded", "Linked"]}
        />
        <Filter
          label="Priority"
          value={fPrio}
            ...
            {all.length === 0 ? (
              <>
                ...
                <p className="text-sm text-muted-foreground max-w-md mx-auto">
                  Generate a first batch of structured SEO opportunities, ranked by language, intent
                  and business value for this project.
                </p>
                <Button
                  className="mt-4"
                  onClick={async () => {
            ...
            >
              <div className="flex items-start justify-between gap-3">
                <div className="flex flex-wrap gap-1.5">
                  ...
                  <Tag tone={o.priority === "High" ? "gold" : "muted"}>
              ...
              <div className="mt-5 flex gap-2 flex-wrap pt-4 border-t border-border">
                ...
                <Button
                  ...
                  onClick={() => {
                    updateOpportunity(o.id, { status: "Discarded" });
