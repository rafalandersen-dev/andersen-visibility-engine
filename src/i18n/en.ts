...
export const en: Record<string, string> = {
  ...
  "prev.mobileTitle": "Mobile preview",
  "imgGen.generate": "Generate with AI",
  "imgGen.needConcept": "Describe the image first — fill the concept field.",
  "imgGen.done": "Image generated — review it, adjust the alt text, then Approve.",
  ...
  "arrange.hookNone": "No hook yet — add one in the Content tab.",
  "arrange.hookPlaceholder": "One-sentence opening hook…",
  "arrange.dragHint": "Drag to a drop zone · click for controls",
  "arrange.inlineControls": "Image controls",
  "arrange.status": "Status",
  "arrange.attention": "Needs placement",
  "arrange.attentionHint":
    "These images are excluded from the article until placed: drag each onto a drop zone.",
  "arrange.altPlaceholder": "Alt text",
  "arrange.captionPlaceholder": "Caption (optional)",
  "arrange.zone.before-hook": "Before hook",
  "arrange.zone.after-hook": "After hook",
  "arrange.zone.beforeSection": "Before",
  "arrange.zone.afterSection": "After",
  "arrange.zone.before-faq": "Before FAQ",
  "arrange.zone.before-cta": "Before CTA",
  "arrange.zone.article-end": "End of article",
  "arrange.status.resolved": "Placed",
  "arrange.status.broken": "Broken anchor",
  "arrange.status.ambiguous": "Ambiguous anchor",
  "arrange.status.unplaced": "Not approved / missing alt",
  "arrange.status.invalid": "Invalid placement",
  "arrange.unplacedNote": "Publishes after the body — drag to place precisely",
  "visual.upgradePrompt":
    "This article predates Article Studio 3.0. Upgrade it to add an opening hook, featured image and visual placement — the 3.0 checks then apply.",
  "visual.upgradeAction": "Upgrade to 3.0",
  "visual.completeness": "Visual completeness",
  "visual.missing.hook": "approve the hook",
  "visual.missing.featured": "set a featured image",
  "visual.missing.placement": "place all images",
  "visual.missing.images": "add imagery",
  "linknet.title": "Link Growth Network",
  "linknet.subtitle":
    "Get matched with relevant sites in the Milo network, send a personal introduction, and let Milo verify the link is actually live.",
  "linknet.policyNote":
    "Relevance-first by design: matches need shared topics, plain link swaps are flagged, and nothing is ever placed automatically — this keeps your link profile safe with Google.",
  "linknet.topics": "Topics",
  "linknet.topicsPlaceholder": "Topics (comma separated)",
  "linknet.contact": "Contact email",
  "linknet.contactPlaceholder": "Contact email for partners",
  "linknet.join": "Join the network",
  "linknet.update": "Update listing",
  "linknet.pause": "Pause",
  "linknet.joined": "Listed — partners can now find this site.",
  "linknet.paused": "Listing paused.",
  "linknet.find": "Find partners",
  "linknet.noMatches":
    "No relevant partners yet — the network grows with every Milo site that joins.",
  "linknet.score": "Match",
  "linknet.copyIntro": "Copy intro email",
  "linknet.introCopied": "Introduction copied — paste it into your email.",
  "linknet.markContacted": "Mark contacted",
  "linknet.markAgreed": "Mark agreed",
  "linknet.decline": "Decline",
  "linknet.targetUrlPlaceholder": "Agreed page URL (where the link will live)",
  "linknet.verify": "Verify link",
  "linknet.verified": "Link found — placement is live and verified.",
  "linknet.notFound": "No link found on that page yet — checked and recorded.",
  "linknet.liveSince": "Live since",
  "linknet.nofollow": "nofollow",
  "linknet.lastCheckMiss": "Last check: link not found",
  "linknet.reciprocalWarn":
    "Heads up: this would complete a direct link swap with this site — fine once, but Google flags excessive exchanges.",
  "linknet.status.suggested": "Suggested",
  "linknet.status.contacted": "Contacted",
  ...
  "report.branding.note": "Your agency name and logo appear on the printed PDF and in the report email — Milo branding steps back.",
  "report.branding.name": "Agency name",
  "report.branding.logoUrl": "Logo URL",
  "report.branding.save": "Save branding",
  "report.branding.saved": "Branding saved",
  "report.branding.saveFailed": "Could not save branding",
  "report.footer.agency": "{agency}. Based on saved publication results. This report does not recheck whether pages are currently live.",
  "report.title": "Monthly proof report",
  "report.subtitle": "What Milo shipped for you this month — and what happens next.",
  ...
  "report.published.note": "Based on saved publication results. This report does not recheck whether pages are currently live.",
  "report.published.empty": "No publications recorded for this month.",
  "report.stat.drafted": "Drafts written",
  "report.stat.scheduled": "Scheduled",
  "report.stat.linksLive": "Partner links Live ✓",
  "report.stat.gscClicks": "GSC clicks",
  "report.gsc.title": "Search snapshot",
  "report.gsc.line": "{clicks} clicks · {impressions} impressions · avg. position {position}",
  "report.gsc.importedAt": "Data imported {date}",
  "report.gsc.empty": "Connect Google Search Console in Settings to include search metrics.",
  "report.plan.title": "Next month's plan ({count})",
  "report.plan.empty": "Nothing planned yet — open the Plan page to schedule next month.",
  "report.footer": "Milo Growth. Based on saved publication results. This report does not recheck whether pages are currently live.",
  "shell.trust": "EU Trust Centre",
  "shell.nav.home": "Home",
  "shell.nav.plan": "Plan",
  "shell.nav.content": "Content",
  "shell.nav.backlinks": "Backlinks",
  "shell.nav.insights": "Insights",
  "shell.nav.settings": "Settings",
  "shell.nav.planWorkspace": "Plan workspace",
  "shell.nav.discover": "Discover",
  "shell.nav.onpage": "On-page review",
  "shell.nav.competitors": "Competitors",
  "shell.nav.authority": "Authority",
  "shell.nav.aiReadiness": "AI readiness",
  "shell.nav.proposals": "Proposals",
  "shell.nav.contentLibrary": "Content library",
  "shell.nav.aiEvaluation": "AI evaluation",
  "shell.nav.linkIntelligence": "Link intelligence",
  "shell.nav.marketplace": "Marketplace",
  "shell.nav.outreach": "Outreach",
  "shell.nav.premiumAnalytics": "Premium analytics",
  "shell.nav.projectSetup": "Project setup",
  "shell.nav.services": "Services & products",
  "shell.nav.connectedApps": "Connected apps",
  "shell.nav.billing": "Billing & subscription",
  "shell.nav.launchChecklist": "Launch checklist",
  "shell.nav.betaValidation": "Beta validation",
  "shell.tagline": "Monthly AI growth planner",
  "shell.chooseProject": "Choose a project",
  "shell.projects": "Projects",
  "shell.editProject": "Edit current project",
  "shell.addProject": "Add project",
  "shell.menu": "Menu",
  "shell.billing": "Billing",
  "shell.activeProject": "Active project",
  "shell.account": "Account",
  "shell.manageSubscription": "Manage or cancel subscription",
  "shell.signOut": "Sign out",
  "shell.footerBuiltBy": "Milo Growth — built by Andersen Innovations",
  "shell.language": "Interface language",
  "shell.languageProjectDefault": "Project default",
  ...
  "actions.brand.voice.tone": "Brand tone",
  "actions.brand.voice.styleNotes": "Writing style",
  "actions.brand.voice.wordsToUse": "Preferred wording",
  "actions.brand.voice.wordsToAvoid": "Wording to avoid",
  "actions.brand.claims.allowedClaims": "Allowed claims",
  "actions.brand.claims.forbiddenClaims": "Forbidden claims",
  "actions.brand.claims.requiredCaveats": "Required caveats",
  "actions.brand.offers.primaryOffers": "Primary offers",
  "actions.brand.offers.secondaryOffers": "Secondary offers",
  "actions.brand.proof.proofPoints": "Supporting evidence",
  "actions.brand.proof.credentials": "Credentials",
  "actions.brand.proof.testimonialsNotes": "Customer review notes",
  "actions.brand.proof.trustSignals": "Trust signals",
  "actions.brand.ctas.primaryCtaLabel": "Primary call to action",
  "actions.brand.ctas.primaryCtaUrl": "Primary action link",
  "actions.brand.ctas.secondaryCtaLabel": "Secondary call to action",
  "actions.brand.ctas.secondaryCtaUrl": "Secondary action link",
  "actions.brand.ctas.ctaStyleNotes": "Call-to-action style",
  "actions.brand.internalLinks": "Preferred internal links",
  "actions.brand.marketLanguageRules": "Market and language guidance",
  "actions.brand.avoid": "Other content to avoid",
