...
export const emailSettingsCopy: Record<OnboardingLanguage, Record<string, string>> = {
  en: {
    ...
    "emailSettings.uncertain":
      "The saved settings could not be confirmed. Reload them before another change; your last change may already have been saved.",
    "emailSettings.reload": "Reload saved settings (discard edits)",
  },
  pl: {
    ...
    "emailSettings.uncertain":
      "Nie można potwierdzić zapisu ustawień. Wczytaj je przed kolejną zmianą; ostatnia zmiana mogła już zostać zapisana.",
    "emailSettings.reload": "Wczytaj zapisane ustawienia (odrzuć zmiany)",
  },
  sv: {
    ...
    "emailSettings.uncertain":
      "De sparade inställningarna kunde inte bekräftas. Läs in dem före nästa ändring; din senaste ändring kan redan ha sparats.",
    "emailSettings.reload": "Läs in sparade inställningar (kasta ändringar)",
  },
  da: {
    ...
    "emailSettings.uncertain":
      "De gemte indstillinger kunne ikke bekræftes. Indlæs dem før næste ændring; din seneste ændring kan allerede være gemt.",
    "emailSettings.reload": "Indlæs gemte indstillinger (kassér ændringer)",
  },
};
