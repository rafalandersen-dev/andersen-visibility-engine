...
export const pl: Record<string, string> = {
  ...
  "marketplace.request": "Poproś o weryfikację", "marketplace.reviewPrice": "Sprawdź cenę", "marketplace.requested": "Zgłoszono", "marketplace.ordersEmpty": "Brak zgłoszeń publikacji.",
