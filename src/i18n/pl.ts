...
export const pl: Record<string, string> = {
  ...
  "imgGen.generate": "Wygeneruj z AI",
  "imgGen.needConcept": "Najpierw opisz obraz — wypełnij pole koncepcji.",
  "imgGen.done": "Obraz wygenerowany — obejrzyj go, popraw tekst alternatywny i zatwierdź.",
  ...
  "arrange.hookNone": "Brak hooka — dodaj go w zakładce Treść.",
  "arrange.hookPlaceholder": "Jednozdaniowy hook otwierający…",
  "arrange.dragHint": "Przeciągnij do strefy · kliknij po kontrolki",
  "arrange.inlineControls": "Kontrolki obrazu",
  "arrange.status": "Status",
  "arrange.attention": "Wymaga umieszczenia",
  "arrange.attentionHint":
    "Te obrazy są wyłączone z artykułu do czasu umieszczenia: przeciągnij każdy na strefę upuszczania.",
  "arrange.altPlaceholder": "Tekst alternatywny",
  "arrange.captionPlaceholder": "Podpis (opcjonalnie)",
  "arrange.zone.before-hook": "Przed hookiem",
  "arrange.zone.after-hook": "Po hooku",
  "arrange.zone.beforeSection": "Przed",
  "arrange.zone.afterSection": "Po",
  "arrange.zone.before-faq": "Przed FAQ",
  "arrange.zone.before-cta": "Przed CTA",
  "arrange.zone.article-end": "Koniec artykułu",
  "arrange.status.resolved": "Umieszczony",
  "arrange.status.broken": "Uszkodzona kotwica",
  "arrange.status.ambiguous": "Niejednoznaczna kotwica",
  "arrange.status.unplaced": "Niezatwierdzony / brak alt",
  "arrange.status.invalid": "Nieprawidłowe umieszczenie",
  "arrange.unplacedNote": "Publikuje się po treści — przeciągnij, aby umieścić precyzyjnie",
  "visual.upgradePrompt":
    "Ten artykuł powstał przed Article Studio 3.0. Ulepsz go, aby dodać hook otwierający, obraz wyróżniający i rozmieszczenie wizualne — wtedy obowiązują kontrole 3.0.",
  "visual.upgradeAction": "Ulepsz do 3.0",
  "visual.completeness": "Kompletność wizualna",
  "visual.missing.hook": "zatwierdź hook",
  "visual.missing.featured": "ustaw obraz wyróżniający",
  "visual.missing.placement": "umieść wszystkie obrazy",
  "visual.missing.images": "dodaj grafiki",
  "linknet.title": "Sieć wymiany linków",
  "linknet.subtitle":
    "Dopasuj się do tematycznie powiązanych stron w sieci Milo, wyślij osobiste zaproszenie, a Milo zweryfikuje, że link faktycznie działa.",
  "linknet.policyNote":
    "Z założenia najpierw trafność: dopasowania wymagają wspólnych tematów, proste wymiany linków są oznaczane, a nic nie jest umieszczane automatycznie — to chroni Twój profil linków w Google.",
  "linknet.topics": "Tematy",
  "linknet.topicsPlaceholder": "Tematy (po przecinku)",
  "linknet.contact": "E-mail kontaktowy",
  "linknet.contactPlaceholder": "E-mail kontaktowy dla partnerów",
  "linknet.join": "Dołącz do sieci",
  "linknet.update": "Aktualizuj wpis",
  "linknet.pause": "Wstrzymaj",
  "linknet.joined": "Dodano — partnerzy mogą teraz znaleźć tę stronę.",
  "linknet.paused": "Wpis wstrzymany.",
  "linknet.find": "Znajdź partnerów",
  "linknet.noMatches": "Brak trafnych partnerów — sieć rośnie z każdą stroną Milo, która dołącza.",
  "linknet.score": "Dopasowanie",
  "linknet.copyIntro": "Kopiuj e-mail intro",
  "linknet.introCopied": "Zaproszenie skopiowane — wklej je do e-maila.",
  "linknet.markContacted": "Oznacz: skontaktowano",
  "linknet.markAgreed": "Oznacz: uzgodniono",
  "linknet.decline": "Odrzuć",
  "linknet.targetUrlPlaceholder": "Uzgodniony URL strony (gdzie będzie link)",
  "linknet.verify": "Zweryfikuj link",
  "linknet.verified": "Link znaleziony — umieszczenie jest aktywne i zweryfikowane.",
  "linknet.notFound": "Nie znaleziono jeszcze linku na tej stronie — sprawdzono i zapisano.",
  "linknet.liveSince": "Aktywny od",
  "linknet.nofollow": "nofollow",
  "linknet.lastCheckMiss": "Ostatnie sprawdzenie: brak linku",
  "linknet.reciprocalWarn":
    "Uwaga: to domknęłoby bezpośrednią wymianę linków z tą stroną — raz jest w porządku, ale Google oznacza nadmierne wymiany.",
  "linknet.status.suggested": "Sugerowane",
  "linknet.status.contacted": "Skontaktowano",
  ...
  "report.branding.note": "Nazwa i logo Twojej agencji pojawią się na PDF-ie i w e-mailu raportu — branding Milo schodzi na bok.",
  "report.branding.name": "Nazwa agencji",
  "report.branding.logoUrl": "URL logo",
  ...
  "report.stat.gscClicks": "Kliknięcia GSC",
  "report.gsc.title": "Widok z wyszukiwarki",
  "report.gsc.line": "{clicks} kliknięć · {impressions} wyświetleń · śr. pozycja {position}",
  "report.gsc.importedAt": "Dane zaimportowane {date}",
  ...
  "shell.nav.backlinks": "Linki",
  "shell.nav.insights": "Analizy",
  "shell.nav.settings": "Ustawienia",
  "shell.nav.planWorkspace": "Obszar planu",
  "shell.nav.discover": "Odkrywaj",
  "shell.nav.onpage": "Przegląd on-page",
  "shell.nav.competitors": "Konkurencja",
  "shell.nav.authority": "Autorytet",
  "shell.nav.aiReadiness": "Gotowość AI",
  "shell.nav.proposals": "Propozycje",
  "shell.nav.contentLibrary": "Biblioteka treści",
  "shell.nav.aiEvaluation": "Ocena AI",
  "shell.nav.linkIntelligence": "Analiza linków",
  "shell.nav.marketplace": "Marketplace",
  "shell.nav.outreach": "Outreach",
  "shell.nav.premiumAnalytics": "Analityka premium",
  "shell.nav.projectSetup": "Konfiguracja projektu",
  "shell.nav.services": "Usługi i produkty",
  "shell.nav.connectedApps": "Połączone aplikacje",
  "shell.nav.billing": "Płatności i subskrypcja",
  "shell.nav.launchChecklist": "Checklista startu",
  "shell.nav.betaValidation": "Walidacja beta",
  "shell.tagline": "Miesięczny planer wzrostu AI",
  "shell.chooseProject": "Wybierz projekt",
  "shell.projects": "Projekty",
  "shell.editProject": "Edytuj bieżący projekt",
  "shell.addProject": "Dodaj projekt",
  "shell.menu": "Menu",
  "shell.billing": "Płatności",
  "shell.activeProject": "Aktywny projekt",
  "shell.account": "Konto",
  "shell.manageSubscription": "Zarządzaj subskrypcją lub anuluj",
  "shell.signOut": "Wyloguj się",
  "shell.footerBuiltBy": "Milo Growth — stworzone przez Andersen Innovations",
  "shell.language": "Język interfejsu",
  "shell.languageProjectDefault": "Domyślny projektu",
  "shell.closeNav": "Zamknij nawigację",
  "shell.primaryNav": "Nawigacja główna",
  "shell.addOn": "Dodatek",
  "shell.terms": "Regulamin",
  "shell.privacy": "Prywatność",
  "shell.security": "Bezpieczeństwo",
  "shell.aiDisclaimer": "Nota AI",
  ...
  "gsc.oauth.chooseProperty": "Wybierz usługę Search Console pasującą do tego projektu.",
  "gsc.oauth.loadSites": "Wczytaj usługi",
  "gsc.oauth.selectProperty": "Wybierz usługę",
  "gsc.oauth.selectedProperty": "Wybrana usługa",
  "gsc.oauth.changeProperty": "Zmień usługę",
  "gsc.oauth.selected": "Usługa wybrana.",
  "gsc.oauth.selectError": "Nie udało się wybrać tej usługi. Spróbuj ponownie.",
  "gsc.oauth.sync28": "Synchronizuj ostatnie 28 dni",
  ...
  "gsc.oauth.syncToast": "Zsynchronizowano {rows} wierszy z Search Console.",
  "gsc.oauth.syncError": "Nie udało się zsynchronizować danych Search Console. Spróbuj ponownie.",
  "gsc.oauth.sitesError": "Nie udało się wczytać usług Search Console. Spróbuj ponownie.",
  "gsc.oauth.noSites": "Nie znaleziono zweryfikowanych usług Search Console na tym koncie.",
  "gsc.oauth.disconnected": "Rozłączono Google Search Console.",
  "gsc.oauth.status.connected": "Połączono",
  "gsc.oauth.status.disconnected": "Rozłączono",
  ...
  "claude.never": "nigdy",
  "claude.revoke": "Unieważnij token",
  ...
  "connect.readOnly": "Dostęp tylko do odczytu",
  "connect.requesting": "Prośba o dostęp do",
  "connect.canTitle": "Claude będzie mógł",
  "connect.cannotTitle": "Claude NIE będzie mógł",
  "connect.can.projects": "Czytać Twoje projekty i profil marki",
  "connect.can.content": "Czytać Twoje szanse, szkice i Milo Score",
  "connect.can.insights": "Czytać Twoje audyty i podsumowania Search Console",
  "connect.can.authority": "Czytać Twoje szanse autorytetu",
  "connect.cannot.create": "Tworzyć treści",
  "connect.cannot.edit": "Edytować treści",
  "connect.cannot.publish": "Publikować treści",
  "connect.cannot.delete": "Niczego usuwać",
  "connect.cannot.settings": "Zmieniać ustawień",
  "connect.cannot.billing": "Uzyskać dostępu do płatności lub danych rozliczeniowych",
  "connect.cannot.approve": "Zatwierdzać lub stosować własne propozycje",
  "connect.allow": "Zezwól na dostęp",
  "connect.cancel": "Anuluj",
  "connect.footer": "Możesz odłączyć Claude w dowolnym momencie w ustawieniach projektu.",
  "connect.error.title": "Żądanie autoryzacji niedostępne",
  "connect.error.notFound": "Nie znaleziono tego żądania autoryzacji.",
  "connect.error.expired": "To żądanie autoryzacji wygasło.",
  "connect.error.used": "To żądanie autoryzacji zostało już użyte.",
  "connect.error.client": "Aplikacja żądająca jest nieznana lub wyłączona.",
  "connect.error.restart": "Zacznij ponownie z Claude.",
  ...
  "launch.conn.gsc.csvOnly": "CSV zaimportowany (OAuth niepołączony).",
  "launch.conn.gsc.synced": "OAuth połączony i zsynchronizowany.",
  "launch.conn.gsc.connectedNotSynced": "Połączono — uruchom synchronizację.",
  "launch.conn.gsc.reconnect": "Połączenie wymaga ponownego połączenia.",
  ...
  "launch.qa.gscOAuth": "GSC OAuth skonfigurowany",
  "launch.qa.gscConnected": "Połączenie GSC",
  "launch.qa.gscSite": "Wybrana usługa GSC",
  "launch.qa.gscSyncRows": "Wiersze ostatniej synchr. GSC",
  "launch.qa.gscSyncDate": "Data ostatniej synchr. GSC",
  ...
  "actions.status.rejected": "Odrzucona",
  "actions.status.expired": "Wygasła",
  "actions.risk.low": "Niskie ryzyko",
  ...
  "actions.card.created": "Utworzona",
  "actions.card.expires": "Wygasa",
  ...
  "actions.brand.voice.tone": "Ton marki",
  "actions.brand.voice.styleNotes": "Styl pisania",
  "actions.brand.voice.wordsToUse": "Preferowane słownictwo",
  "actions.brand.voice.wordsToAvoid": "Słownictwo do unikania",
  "actions.brand.claims.allowedClaims": "Dozwolone stwierdzenia",
  "actions.brand.claims.forbiddenClaims": "Niedozwolone stwierdzenia",
  "actions.brand.claims.requiredCaveats": "Wymagane zastrzeżenia",
  "actions.brand.offers.primaryOffers": "Główne oferty",
  "actions.brand.offers.secondaryOffers": "Dodatkowe oferty",
  "actions.brand.proof.proofPoints": "Dowody potwierdzające",
  "actions.brand.proof.credentials": "Kwalifikacje i certyfikaty",
  "actions.brand.proof.testimonialsNotes": "Uwagi o opiniach klientów",
  "actions.brand.proof.trustSignals": "Sygnały wiarygodności",
  "actions.brand.ctas.primaryCtaLabel": "Główne wezwanie do działania",
  "actions.brand.ctas.primaryCtaUrl": "Link głównego działania",
  "actions.brand.ctas.secondaryCtaLabel": "Dodatkowe wezwanie do działania",
  "actions.brand.ctas.secondaryCtaUrl": "Link dodatkowego działania",
  "actions.brand.ctas.ctaStyleNotes": "Styl wezwań do działania",
  "actions.brand.internalLinks": "Preferowane linki wewnętrzne",
  "actions.brand.marketLanguageRules": "Wytyczne rynku i języka",
  "actions.brand.avoid": "Pozostałe treści do unikania",
  "actions.detail.profile": "Profil firmy",
  "actions.detail.overwrite": "Nadpisuje obecne",
  "actions.detail.stateAdd": "Nowe",
  ...
  "backlinks.score.gap": "Luka vs konkurencja",
  "backlinks.score.quality": "Jakość linków",
  "backlinks.gapHint": "wyżej = więcej do zyskania",
  "backlinks.summaryHeading": "Podsumowanie",
  "backlinks.topActions": "Najważniejsze ruchy linkowe",
  "backlinks.profileTable": "Twoja domena vs konkurencja",
  "backlinks.table.domain": "Domena",
  "backlinks.table.rank": "Ranga domeny",
  "backlinks.table.backlinks": "Linki zwrotne",
  "backlinks.table.referringDomains": "Domeny linkujące",
  "backlinks.table.broken": "Uszkodzone",
  "backlinks.table.spam": "Wskaźnik spamu",
  ...
  "backlinks.approach": "Podejście",
  "backlinks.action.convert": "Utwórz szansę",
  "backlinks.action.converted": "Szansa utworzona",
  "backlinks.action.convertTop": "Konwertuj najważniejsze rekomendacje",
  "backlinks.toast.done": "Analiza linków zakończona",
  "backlinks.toast.converted": "Szansa utworzona",
  "backlinks.toast.convertedTop": "Utworzono szanse: {count}",
  "backlinks.category.linkGapTargets": "Cele z luki linkowej",
  "backlinks.category.contentForLinks": "Treści przyciągające linki",
  "backlinks.category.digitalPr": "Digital PR",
  "backlinks.category.partnerships": "Partnerstwa i sponsoring",
  "backlinks.category.directories": "Katalogi i profile",
  ...
  "pipeline.stage.queued": "W kolejce",
  "pipeline.stage.planned": "Zaplanowane",
  "pipeline.stage.writing": "Piszemy",
  "pipeline.stage.in_review": "Do przeglądu",
  "pipeline.stage.ready": "Gotowe",
  ...
  "pipeline.action.setDate": "Ustaw termin",
  "pipeline.action.write": "Napisz",
  "pipeline.action.continueDraft": "Dokończ szkic",
  "pipeline.action.review": "Przejrzyj",
  "pipeline.action.schedule": "Ustaw czas publikacji",
  ...
  "hook.approval.approved": "Zatwierdzony",
  "hook.proposals.label": "Proponowane haki",
  "hook.field.text": "Treść haka",
  "hook.field.type": "Typ",
  "hook.field.purpose": "Cel (opcjonalnie)",
  "hook.action.add": "Dodaj hak otwierający",
  "hook.action.approve": "Zatwierdź hak",
  "hook.action.approved": "Zatwierdzony",
  "hook.action.remove": "Usuń",
  "hook.action.suggested": "Sugerowane",
  "hook.type.question": "Pytanie",
  "hook.type.problem-to-solution": "Problem → rozwiązanie",
  "hook.type.surprising-fact": "Zaskakujący fakt",
  "hook.type.contrarian": "Przekorny",
  ...
  "hook.resolution.change-hook-type": "Zmień typ haka",
  "hook.resolution.remove-unsupported-claim": "Usuń niepotwierdzone twierdzenie",
  "hook.resolution.request-human-confirmation": "Poproś o potwierdzenie przez człowieka",
  ...
  // ---- Kalendarz: planowanie publikacji przeciągnięciem ----
  "calsched.title.ready": "Zaplanować publikację?",
  "calsched.title.notReady": "Nie jest gotowe do publikacji",
  ...
  "calsched.openEditor": "Otwórz w edytorze",
  "calsched.targetOnly": "Ustaw tylko termin roboczy",
  "calsched.setTarget": "Ustaw termin na {date}",
  "calsched.arm": "Zaplanuj publikację",
  "calsched.move": "Przenieś publikację",
  "calsched.badge.notReady": "Niegotowe",
  "calsched.badge.willFail": "Nie powiedzie się — niegotowe",
  "calsched.banner": "{count} artykuł(y) z datą w ciągu 7 dni nie są gotowe do publikacji.",
  "calsched.banner.armed": "publikacja {when}",
  "calsched.banner.target": "termin {when}",
  "calsched.banner.more": "+{count} więcej w kalendarzu.",

  // ---- Article Studio 3.0 — Prezentacja obrazu (P1.2D) ----
  "pres.label": "Prezentacja",
  "pres.add": "Dodaj prezentację",
  "pres.clear": "Wyczyść",
  "pres.field.size": "Rozmiar",
  "pres.field.alignment": "Wyrównanie",
  "pres.field.aspectRatio": "Proporcje",
  "pres.field.fit": "Dopasowanie",
  "pres.field.visualStyle": "Styl",
  "pres.field.focal": "Punkt centralny (x, y)",
  "pres.field.captionVisible": "Pokaż podpis",
  "pres.val.small": "Mały",
  "pres.val.medium": "Średni",
  "pres.val.large": "Duży",
  "pres.val.wide": "Szeroki",
  "pres.val.full": "Pełny",
  "pres.val.left": "Do lewej",
  "pres.val.center": "Do środka",
  "pres.val.right": "Do prawej",
  "pres.val.original": "Oryginalne",
  "pres.val.square": "Kwadrat (1:1)",
  "pres.val.portrait": "Pionowe (4:5)",
  "pres.val.landscape": "Poziome (4:3)",
  "pres.val.cover": "Wypełnij",
  "pres.val.contain": "Zmieść",
  "pres.val.plain": "Zwykły",
  "pres.val.rounded": "Zaokrąglony",
  "pres.val.card": "Karta",
  "pres.mobile.size": "Rozmiar (mobile)",
