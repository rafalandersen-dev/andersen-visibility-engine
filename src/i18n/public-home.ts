...
export const publicHomeCopy: Record<OnboardingLanguage, Readonly<Record<string, string>>> = {
  en: {
    ...
    "publicHome.settingsBody":
      "Audit, competitors, authority and AI visibility now feed one Plan. Project setup, services, connections and billing live together in Settings. Content and Visibility each have one clear job.",
  ...
  pl: {
    ...
    "publicHome.settingsBody":
      "Audyt, konkurencja, autorytet i widoczność w AI zasilają teraz jeden Plan. Konfiguracja projektu, usługi, połączenia i rozliczenia są razem w Ustawieniach. Treści i Widoczność mają jasno określone role.",
  ...
  sv: {
    ...
    "publicHome.settingsBody":
      "Granskning, konkurrenter, auktoritet och AI-synlighet samlas nu i en Plan. Projektinställningar, tjänster, anslutningar och fakturering finns tillsammans i Inställningar. Innehåll och Synlighet har var sin tydliga uppgift.",
  ...
  da: {
    ...
    "publicHome.settingsBody":
      "Audit, konkurrenter, autoritet og AI-synlighed samles nu i én Plan. Projektopsætning, tjenester, forbindelser og fakturering findes samlet i Indstillinger. Indhold og Synlighed har hver en klar opgave.",
