...
export const da: Record<string, string> = {
  ...
  "marketplace.request": "Anmod om gennemgang", "marketplace.reviewPrice": "Gennemgå pris", "marketplace.requested": "Anmodet", "marketplace.ordersEmpty": "Ingen udgivelsesanmodninger endnu.",
  ...
  "nav.outreach": "AI Outreach", "outreach.title": "AI Outreach", "outreach.subtitle": "Opret personlige, menneskeligt gennemgåede digital-PR-mails.", "outreach.safetyTitle": "Kun kladder.", "outreach.safety": "Milo sender aldrig mails automatisk. Kontroller modtager, fakta og relevans først.",
