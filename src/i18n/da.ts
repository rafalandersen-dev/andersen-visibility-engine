...
export const da: Record<string, string> = {
  ...
  "autoSched.day.6": "Lør",
  "autoSched.day.7": "Søn",
  "prev.cropWarn": "Tjek den mobile beskæring før udgivelse for:",
  "prev.mobileTitle": "Mobil forhåndsvisning",
  "imgGen.generate": "Generér med AI",
  "imgGen.needConcept": "Beskriv billedet først — udfyld konceptfeltet.",
  "imgGen.done": "Billede genereret — gennemgå det, justér alt-teksten og godkend.",
  ...
  "arrange.hookNone": "Ingen hook endnu — tilføj den under Indhold.",
  "arrange.hookPlaceholder": "Indledende hook i én sætning…",
  "arrange.dragHint": "Træk til en slipzone · klik for kontroller",
  "arrange.inlineControls": "Billedkontroller",
  "arrange.status": "Status",
  "arrange.attention": "Skal placeres",
  "arrange.attentionHint":
    "Disse billeder er udeladt af artiklen, indtil de placeres: træk hvert enkelt til en slipzone.",
  "arrange.altPlaceholder": "Alt-tekst",
  "arrange.captionPlaceholder": "Billedtekst (valgfrit)",
  "arrange.zone.before-hook": "Før hook",
  "arrange.zone.after-hook": "Efter hook",
  "arrange.zone.beforeSection": "Før",
  "arrange.zone.afterSection": "Efter",
  "arrange.zone.before-faq": "Før FAQ",
  "arrange.zone.before-cta": "Før CTA",
  "arrange.zone.article-end": "Artiklens slutning",
  "arrange.status.resolved": "Placeret",
  "arrange.status.broken": "Ødelagt anker",
  "arrange.status.ambiguous": "Tvetydigt anker",
  "arrange.status.unplaced": "Ikke godkendt / mangler alt",
  "arrange.status.invalid": "Ugyldig placering",
  "arrange.unplacedNote": "Udgives efter brødteksten — træk for at placere præcist",
  "visual.upgradePrompt":
    "Denne artikel er ældre end Article Studio 3.0. Opgradér den for at tilføje en indledende hook, et fremhævet billede og visuel placering — derefter gælder 3.0-kontrollerne.",
  "visual.upgradeAction": "Opgradér til 3.0",
  "visual.completeness": "Visuel fuldstændighed",
  "visual.missing.hook": "godkend hooken",
  "visual.missing.featured": "angiv et fremhævet billede",
  "visual.missing.placement": "placér alle billeder",
  "visual.missing.images": "tilføj billeder",
  "linknet.title": "Linknetværk",
  "linknet.subtitle":
    "Bliv matchet med tematisk relevante sites i Milo-netværket, send en personlig introduktion, og lad Milo verificere, at linket faktisk er live.",
  "linknet.policyNote":
    "Relevans først, by design: matches kræver fælles emner, rene linkbytter markeres, og intet placeres automatisk — det holder din linkprofil sikker hos Google.",
  "linknet.topics": "Emner",
  "linknet.topicsPlaceholder": "Emner (kommasepareret)",
  "linknet.contact": "Kontaktmail",
  "linknet.contactPlaceholder": "Kontaktmail til partnere",
  "linknet.join": "Deltag i netværket",
  "linknet.update": "Opdatér oplysninger",
  "linknet.pause": "Sæt på pause",
  "linknet.joined": "Oprettet — partnere kan nu finde dette site.",
  "linknet.paused": "Oplysningerne er sat på pause.",
  "linknet.find": "Find partnere",
  "linknet.noMatches":
    "Ingen relevante partnere endnu — netværket vokser med hvert Milo-site, der deltager.",
  "linknet.score": "Match",
  "linknet.copyIntro": "Kopiér intromail",
  "linknet.introCopied": "Introduktionen er kopieret — sæt den ind i din mail.",
  "linknet.markContacted": "Markér kontaktet",
  "linknet.markAgreed": "Markér aftalt",
  "linknet.decline": "Afvis",
  "linknet.targetUrlPlaceholder": "Aftalt side-URL (hvor linket skal ligge)",
  "linknet.verify": "Verificér link",
  "linknet.verified": "Link fundet — placeringen er live og verificeret.",
  "linknet.notFound": "Intet link fundet på siden endnu — kontrolleret og registreret.",
  "linknet.liveSince": "Live siden",
  "linknet.nofollow": "nofollow",
  "linknet.lastCheckMiss": "Seneste tjek: link ikke fundet",
  "linknet.reciprocalWarn":
    "Bemærk: dette ville fuldende et direkte linkbytte med dette site — fint én gang, men Google markerer overdrevne bytter.",
  "linknet.status.suggested": "Foreslået",
  "linknet.status.contacted": "Kontaktet",
  ...
  "report.branding.note": "Dit bureaus navn og logo vises på PDF'en og i rapportmailen — Milos branding træder tilbage.",
  "report.branding.name": "Bureauets navn",
  ...
  "report.stat.gscClicks": "GSC-klik",
  "report.gsc.title": "Søgeøjebliksbillede",
  "report.gsc.line": "{clicks} klik · {impressions} visninger · gns. position {position}",
  "report.gsc.importedAt": "Data importeret {date}",
  ...
  "shell.nav.insights": "Indsigter",
  "shell.nav.settings": "Indstillinger",
  "shell.nav.planWorkspace": "Planområde",
  "shell.nav.discover": "Opdag",
  "shell.nav.onpage": "On-page-gennemgang",
  "shell.nav.competitors": "Konkurrenter",
  "shell.nav.authority": "Autoritet",
  "shell.nav.aiReadiness": "AI-parathed",
  "shell.nav.proposals": "Forslag",
  "shell.nav.contentLibrary": "Indholdsbibliotek",
  "shell.nav.aiEvaluation": "AI-evaluering",
  "shell.nav.linkIntelligence": "Linkanalyse",
  "shell.nav.marketplace": "Markedsplads",
  "shell.nav.outreach": "Outreach",
  "shell.nav.premiumAnalytics": "Premium-analyse",
  "shell.nav.projectSetup": "Projektopsætning",
  "shell.nav.services": "Tjenester & produkter",
  "shell.nav.connectedApps": "Forbundne apps",
  "shell.nav.billing": "Betaling & abonnement",
  "shell.nav.launchChecklist": "Lanceringstjekliste",
  "shell.nav.betaValidation": "Betavalidering",
  "shell.tagline": "Månedlig AI-vækstplanlægger",
  "shell.chooseProject": "Vælg et projekt",
  "shell.projects": "Projekter",
  "shell.editProject": "Redigér nuværende projekt",
  "shell.addProject": "Tilføj projekt",
  "shell.menu": "Menu",
  "shell.billing": "Betaling",
  "shell.activeProject": "Aktivt projekt",
  "shell.account": "Konto",
  "shell.manageSubscription": "Administrér eller opsig abonnement",
  "shell.signOut": "Log ud",
  "shell.footerBuiltBy": "Milo Growth — bygget af Andersen Innovations",
  "shell.language": "Grænsefladesprog",
  "shell.languageProjectDefault": "Projektets standard",
  "shell.closeNav": "Luk navigation",
  "shell.primaryNav": "Hovednavigation",
  "shell.addOn": "Tilføjelse",
  "shell.terms": "Vilkår",
  "shell.privacy": "Privatliv",
  "shell.security": "Sikkerhed",
  "shell.aiDisclaimer": "AI-oplysning",
  ...
  "gsc.oauth.chooseProperty": "Vælg den Search Console-ejendom, der matcher dette projekt.",
  "gsc.oauth.loadSites": "Indlæs ejendomme",
  "gsc.oauth.selectProperty": "Vælg ejendom",
  "gsc.oauth.selectedProperty": "Valgt ejendom",
  "gsc.oauth.changeProperty": "Skift ejendom",
  "gsc.oauth.selected": "Ejendom valgt.",
  "gsc.oauth.selectError": "Kunne ikke vælge den ejendom. Prøv igen.",
  "gsc.oauth.sync28": "Synk seneste 28 dage",
  ...
  "gsc.oauth.syncToast": "Synkede {rows} rækker fra Search Console.",
  "gsc.oauth.syncError": "Kunne ikke synke Search Console-data. Prøv igen.",
  "gsc.oauth.sitesError": "Kunne ikke indlæse Search Console-ejendomme. Prøv igen.",
  "gsc.oauth.noSites": "Ingen verificerede Search Console-ejendomme fundet på denne konto.",
  "gsc.oauth.disconnected": "Google Search Console afbrudt.",
  "gsc.oauth.status.connected": "Forbundet",
  "gsc.oauth.status.disconnected": "Afbrudt",
  ...
  "claude.generate": "Generér forbindelsestoken",
  "claude.tokenOnce": "Kopiér denne token nu — den vises kun én gang og kan ikke gendannes.",
  "claude.copy": "Kopiér",
  "claude.copied": "Kopieret",
  ...
  "claude.noTokens": "Ingen forbindelsestokens endnu. Generér en for at forbinde Claude.",
  "claude.unnamed": "Token uden navn",
  "claude.created": "Oprettet",
  "claude.lastUsed": "sidst brugt",
  "claude.never": "aldrig",
  "claude.revoke": "Tilbagekald token",
  "claude.revoked": "Token tilbagekaldt.",
  "claude.revokeError": "Kunne ikke tilbagekalde token. Prøv igen.",
  ...
  "connect.readOnly": "Skrivebeskyttet adgang",
  "connect.requesting": "Anmoder om adgang til",
  "connect.canTitle": "Claude vil kunne",
  "connect.cannotTitle": "Claude vil IKKE kunne",
  "connect.can.projects": "Læse dine projekter og brandprofil",
  "connect.can.content": "Læse dine muligheder, udkast og Milo Score",
  "connect.can.insights": "Læse dine revisioner og Search Console-oversigter",
  "connect.can.authority": "Læse dine autoritetsmuligheder",
  "connect.cannot.create": "Oprette indhold",
  "connect.cannot.edit": "Redigere indhold",
  "connect.cannot.publish": "Udgive indhold",
  "connect.cannot.delete": "Slette noget",
  "connect.cannot.settings": "Ændre indstillinger",
  "connect.cannot.billing": "Få adgang til fakturering eller betalingsoplysninger",
  "connect.cannot.approve": "Godkende eller anvende sine egne forslag",
  "connect.allow": "Tillad adgang",
  "connect.cancel": "Annuller",
  "connect.footer": "Du kan afbryde Claude når som helst i Projektopsætning.",
  "connect.error.title": "Autorisationsanmodning utilgængelig",
  "connect.error.notFound": "Denne autorisationsanmodning kunne ikke findes.",
  "connect.error.expired": "Denne autorisationsanmodning er udløbet.",
  "connect.error.used": "Denne autorisationsanmodning er allerede blevet brugt.",
  "connect.error.client": "Den anmodende app er ukendt eller deaktiveret.",
  "connect.error.restart": "Start forfra fra Claude.",
  ...
  "launch.conn.gsc.csvOnly": "CSV importeret (OAuth ikke forbundet).",
  "launch.conn.gsc.synced": "OAuth forbundet og synket.",
  "launch.conn.gsc.connectedNotSynced": "Forbundet — kør en synk.",
  "launch.conn.gsc.reconnect": "Forbindelsen skal genoprettes.",
  ...
  "launch.qa.gscOAuth": "GSC OAuth konfigureret",
  "launch.qa.gscConnected": "GSC-forbindelse",
  "launch.qa.gscSite": "GSC valgt ejendom",
  "launch.qa.gscSyncRows": "GSC rækker seneste synk",
  "launch.qa.gscSyncDate": "GSC dato seneste synk",
  ...
  "actions.status.rejected": "Afvist",
  "actions.status.expired": "Udløbet",
  "actions.risk.low": "Lav risiko",
  ...
  "actions.card.created": "Oprettet",
  "actions.card.expires": "Udløber",
  ...
  "actions.brand.voice.tone": "Brandets tone",
  "actions.brand.voice.styleNotes": "Skrivestil",
  "actions.brand.voice.wordsToUse": "Foretrukne formuleringer",
  "actions.brand.voice.wordsToAvoid": "Formuleringer, der skal undgås",
  "actions.brand.claims.allowedClaims": "Tilladte påstande",
  "actions.brand.claims.forbiddenClaims": "Forbudte påstande",
  "actions.brand.claims.requiredCaveats": "Påkrævede forbehold",
  "actions.brand.offers.primaryOffers": "Primære tilbud",
  "actions.brand.offers.secondaryOffers": "Sekundære tilbud",
  "actions.brand.proof.proofPoints": "Understøttende dokumentation",
  "actions.brand.proof.credentials": "Kvalifikationer og certifikater",
  "actions.brand.proof.testimonialsNotes": "Noter om kundeanmeldelser",
  "actions.brand.proof.trustSignals": "Troværdighedssignaler",
  "actions.brand.ctas.primaryCtaLabel": "Primær opfordring",
  "actions.brand.ctas.primaryCtaUrl": "Link til primær handling",
  "actions.brand.ctas.secondaryCtaLabel": "Sekundær opfordring",
  "actions.brand.ctas.secondaryCtaUrl": "Link til sekundær handling",
  "actions.brand.ctas.ctaStyleNotes": "Stil for opfordringer",
  "actions.brand.internalLinks": "Foretrukne interne links",
  "actions.brand.marketLanguageRules": "Retningslinjer for marked og sprog",
  "actions.brand.avoid": "Andet indhold, der skal undgås",
  ...
  "backlinks.score.gap": "Gab mod konkurrenter",
  "backlinks.score.quality": "Linkkvalitet",
  "backlinks.gapHint": "højere = mere at vinde",
  "backlinks.summaryHeading": "Opsummering",
  "backlinks.topActions": "Vigtigste linktræk",
  "backlinks.profileTable": "Dit domæne vs konkurrenter",
  "backlinks.table.domain": "Domæne",
  "backlinks.table.rank": "Domænerank",
  "backlinks.table.backlinks": "Backlinks",
  "backlinks.table.referringDomains": "Henvisende domæner",
  "backlinks.table.broken": "Ødelagte",
  ...
  "backlinks.approach": "Tilgang",
  "backlinks.action.convert": "Opret mulighed",
  "backlinks.action.converted": "Mulighed oprettet",
  "backlinks.action.convertTop": "Konverter de vigtigste anbefalinger",
  "backlinks.toast.done": "Linkanalysen er færdig",
  "backlinks.toast.converted": "Mulighed oprettet",
  "backlinks.toast.convertedTop": "{count} muligheder oprettet",
  "backlinks.category.linkGapTargets": "Mål fra linkgabet",
  "backlinks.category.contentForLinks": "Indhold der tiltrækker links",
  ...
  "pipeline.stage.queued": "I kø",
  "pipeline.stage.planned": "Planlagt",
  "pipeline.stage.writing": "Skrives",
  "pipeline.stage.in_review": "Til gennemsyn",
  ...
  "pipeline.action.setDate": "Sæt en måldato",
  "pipeline.action.write": "Skriv den",
  "pipeline.action.continueDraft": "Fortsæt udkastet",
  "pipeline.action.review": "Gennemgå den",
  "pipeline.action.schedule": "Sæt et udgivelsestidspunkt",
  ...
  "hook.approval.approved": "Godkendt",
  "hook.proposals.label": "Foreslåede hooks",
  "hook.field.text": "Hook-tekst",
  "hook.field.type": "Type",
  "hook.field.purpose": "Formål (valgfrit)",
  "hook.action.add": "Tilføj indledende hook",
  "hook.action.approve": "Godkend hook",
  "hook.action.approved": "Godkendt",
  "hook.action.remove": "Fjern",
  "hook.action.suggested": "Forslag",
  "hook.type.question": "Spørgsmål",
  "hook.type.problem-to-solution": "Problem → løsning",
  "hook.type.surprising-fact": "Overraskende fakta",
  "hook.type.contrarian": "Provokerende",
  ...
  "hook.resolution.change-hook-type": "Skift hook-type",
  "hook.resolution.remove-unsupported-claim": "Fjern udokumenteret påstand",
  "hook.resolution.request-human-confirmation": "Bed om menneskelig bekræftelse",
  ...
  // ---- Kalender: planlæg ved at slippe ----
  "calsched.title.ready": "Planlægge udgivelse?",
  "calsched.title.notReady": "Ikke klar til udgivelse",
  ...
  "calsched.openEditor": "Åbn i editoren",
  "calsched.targetOnly": "Sæt kun måldato",
  "calsched.setTarget": "Sæt måldato {date}",
  "calsched.arm": "Planlæg udgivelse",
  ...
  // ---- Article Studio 3.0 — Billedpræsentation (P1.2D) ----
  "pres.label": "Præsentation",
  "pres.add": "Tilføj præsentation",
  "pres.clear": "Ryd",
  "pres.field.size": "Størrelse",
  "pres.field.alignment": "Justering",
  "pres.field.aspectRatio": "Forhold",
  "pres.field.fit": "Tilpasning",
  "pres.field.visualStyle": "Stil",
  "pres.field.focal": "Fokuspunkt (x, y)",
  "pres.field.captionVisible": "Vis billedtekst",
  "pres.val.small": "Lille",
  "pres.val.medium": "Mellem",
  "pres.val.large": "Stor",
  "pres.val.wide": "Bred",
  "pres.val.full": "Fuld",
  "pres.val.left": "Venstre",
  "pres.val.center": "Centreret",
  "pres.val.right": "Højre",
  "pres.val.original": "Original",
  "pres.val.square": "Kvadrat (1:1)",
  "pres.val.portrait": "Stående (4:5)",
  "pres.val.landscape": "Liggende (4:3)",
  "pres.val.cover": "Udfyld",
  "pres.val.contain": "Tilpas",
  "pres.val.plain": "Enkel",
  "pres.val.rounded": "Afrundet",
  "pres.val.card": "Kort",
