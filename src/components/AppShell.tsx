...
const NAV: NavItem[] = [
  ...
  { to: "/app/backlinks", tKey: "nav.backlinks", icon: Link2 },
  { to: "/app/link-marketplace", tKey: "nav.linkMarketplace", icon: ShoppingBasket },
  { to: "/app/outreach", tKey: "nav.outreach", icon: MailPlus },
