        ...
        <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
          ...
          >
            <SheetHeader className="sr-only">
              <SheetTitle>{t("sharedUi.sidebar")}</SheetTitle>
              <SheetDescription>{t("sharedUi.sidebarHelp")}</SheetDescription>
            </SheetHeader>
...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    ...
    >
      <PanelLeft />
      <span className="sr-only">{t("sharedUi.toggleSidebar")}</span>
    </Button>
  );
});
  ...
  ({ className, ...props }, ref) => {
    ...
    return (
      <button
        ref={ref}
        data-sidebar="rail"
        aria-label={t("sharedUi.toggleSidebar")}
        tabIndex={-1}
        onClick={toggleSidebar}
        title={t("sharedUi.toggleSidebar")}
        className={cn(
