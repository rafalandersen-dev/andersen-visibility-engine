...
| 11 | AI mention + sentiment monitoring | PARTIAL (owner-supplied manual intake released; no probing) | Citation Intelligence v1 (`product/CITATION_INTELLIGENCE_SPEC.md`), then M6 | CI-1…CI-4, later P3.1 | v1 (D03, 2026‑09‑14): human-reviewed mentions/recommendations from one manual consumer surface plus native Google/Bing evidence; *superseded for v1:* scheduled probing ≥2 engines and sentiment with confidence (later scope) | mentions detected w/ stored raw answers; confidence shown |
| 12 | AI Overview / citation visibility | PARTIAL (supplied-citation classification released) | Citation Intelligence v1, then M6 | CI-1…CI-4, later P3.1 | v1 (D03, 2026‑09‑14): native GSC generative‑AI impressions and Bing citation share in original units, human-reviewed own/competitor/third‑party citations with five-state source support; *superseded for v1:* automated extraction as the acceptance | citation rate per prompt set, with confidence |
...
| 14 | Conversational query analysis | PARTIAL (`ai_visibility_prompts` library released) | Citation Intelligence v1 panel protocol, then M6 | CI-2, later P3.1 | v1 (D03, 2026‑09‑14): a version-locked owner-reviewed discovery panel of ten questions on one surface, brand panel kept separate; *superseded for v1:* probing as the acceptance | # realistic prompts probed per locale |
