...
| 4 | Content plan / keyword & topic research | PRESENT_BUT_WEAK (LLM) | M4 Content Opportunity Engine | P1.2 | Opportunities seeded from real GSC queries + keyword/SERP evidence; each shows its evidence | % opportunities with real demand evidence attached |
...
| 17 | Search Console monitoring | COMPLETE (query only) | M4/M1 (extend) | P1.2 / P2.1 | Add URL‑Inspection + Sitemaps API | indexation status surfaced per URL |
