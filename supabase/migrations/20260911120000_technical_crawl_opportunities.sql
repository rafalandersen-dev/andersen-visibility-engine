...
BEGIN
 ...
 INSERT INTO public.workspace_entities(user_id,collection,entity_id,ord,data) VALUES(p_user,'opportunities',opportunity,(SELECT coalesce(max(ord),-1)+1 FROM public.workspace_entities WHERE user_id=p_user AND collection='opportunities'),jsonb_build_object(
