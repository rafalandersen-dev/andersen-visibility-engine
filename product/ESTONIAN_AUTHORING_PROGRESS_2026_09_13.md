...
Estonian is staged only: 3,423 of the current 3,768 English interface keys across twenty-seven complete batches. It is excluded from UI_CATALOGS and the language picker. Four UI catalogs remain active; twelve other catalogs are completely authored in staging with acceptance still incomplete.
