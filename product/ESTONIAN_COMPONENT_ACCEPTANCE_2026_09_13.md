# Estonian focused component checks - 13 September 2026

Baseline: d9da6b7 (complete staged Estonian catalog; existing component focus-return implementation). The local harness accepts et, loads ET_STAGED_CATALOG and throws on missing translations. Estonian is passed to the component for language/date formatting. Runtime catalogs and picker remain unchanged.

The Codex in-app browser returned passed: true, locale: et for all nine interaction groups:
