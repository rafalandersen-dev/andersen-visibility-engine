...
| R05 | Reliable scheduled generation and publication | Concurrency/recovery and retained-work inspection deployed; one Butelki scheduled destination verified; full unattended acceptance open | Logged-out run, timezones/DST, dedupe, cancel/reschedule, stale approval, bounded retry, uncertain result recovery and destination verification |
