...
- Remote main: `7f5120291ff35eba36b75ae3baa6e4cb900095d0`, normal merge of P2 source refresh PR #109. P0 #107/P1 #108, the specialist/weekly plan and FAQ fixes are preserved.
...
P0/P1/P2 code/database/runtime releases are complete. Signed-in/browser/provider acceptance remains pending under the existing restrictions. P3 implementation continues in the separate clean branch `codex/milo-p3-weekly-20260910`: exact approval handlers/editor/connector gates and four-locale weekly settings/readiness now join the planner/stage/lease groundwork. Full current suite passes 2,575 tests / 187 files, types/lint/build. Neither P3 migration is applied. The shared weekly executor, actual cron/cutover, pinned research/provenance, budgeted visuals/checks, cancellation/uncertainty controls, summaries and automatic approval authority must be completed before P3 release. Do not repeat P0/P1/P2 release operations.
