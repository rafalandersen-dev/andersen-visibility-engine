...
1. **P0 next:** complete recovery review, migration and runtime verification after the successful local validation. Preserve owner edits, retained results, receipt identities and zero-funded benchmark state. Current main and #105 are reconciled; no recovery PR number is assigned yet.
