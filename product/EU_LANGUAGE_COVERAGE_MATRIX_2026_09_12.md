...
Latest authoring checkpoint - 13 September (latest English source 73e6880): four active complete catalogs, thirteen complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL/HR/BG/ET), Greek partial at 274/3,768 and six unauthored catalogs (HU/GA/LV/LT/MT/RO). Remaining UI authoring backlog: 26,102 messages. Greek three batches pass all 14 focused tests, types, scoped lint, formatting and whitespace. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
