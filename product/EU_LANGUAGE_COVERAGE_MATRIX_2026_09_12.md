...
Latest authoring checkpoint - 13 September (latest English source f0d1d3a): four active complete catalogs, fourteen complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL/HR/BG/ET/EL), and six unauthored catalogs (HU/GA/LV/LT/MT/RO). Greek now covers all 3,768 English keys across twenty-eight batches. Remaining UI authoring backlog: 22,608 messages. All 40 Greek/catalog tests, types, scoped lint, formatting and whitespace pass, including complete English key-set equality. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
