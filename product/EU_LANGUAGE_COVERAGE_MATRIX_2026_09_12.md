...
Latest authoring checkpoint - 13 September (latest English source c0499af): four active complete catalogs and thirteen complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL/HR/BG/ET), with seven unauthored catalogs (EL/HU/GA/LV/LT/MT/RO). Remaining UI authoring backlog: 26,376 messages. Estonian has all 3,768 current English keys across twenty-eight batches, passing all 40 focused tests including full-key equality, types, scoped lint, formatting and whitespace. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
