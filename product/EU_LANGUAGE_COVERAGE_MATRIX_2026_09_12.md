...
Latest authoring checkpoint - 13 September (latest English source b1c987f): four active complete catalogs, fourteen complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL/HR/BG/ET/EL), Hungarian partial at 1,736/3,768 and five unauthored catalogs (GA/LV/LT/MT/RO). Remaining UI authoring backlog: 20,872 messages. Hungarian nineteen batches pass all 30 focused tests, types, scoped lint, formatting and whitespace. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
