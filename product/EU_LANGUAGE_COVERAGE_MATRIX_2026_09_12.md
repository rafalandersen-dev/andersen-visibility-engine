...
Latest authoring checkpoint - 13 September (latest English source 316fc14): four active complete catalogs, twelve complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL/HR/BG), Estonian partial at 855/3,768 and seven unauthored catalogs (EL/HU/GA/LV/LT/MT/RO). Remaining UI authoring backlog: 29,289 messages. Estonian thirteen batches pass all 24 focused tests, types, scoped lint and whitespace. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
