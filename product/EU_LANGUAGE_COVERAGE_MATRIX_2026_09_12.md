...
Latest authoring checkpoint — 13 September (latest English source d0218e9): four active complete catalogs and eleven complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL/HR). Nine catalogs remain unauthored. Remaining UI authoring backlog: 33,912 messages (9 × 3,768). Croatian copy across twenty-eight batches passes all 40 focused tests, including exact complete-English key equality, types, scoped lint and whitespace. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
