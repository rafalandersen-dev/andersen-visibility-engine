...
Latest authoring checkpoint — 13 September (latest English source dce3a94): four active complete catalogs, ten complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL), Croatian partial at 955/3,768 and nine unauthored catalogs. Remaining UI authoring backlog: 36,725 messages. Croatian copy across fourteen batches passes all 25 focused tests, types, scoped lint and whitespace. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
