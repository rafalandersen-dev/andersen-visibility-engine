...
Latest authoring checkpoint - 13 September (latest English source 1994df4): four active complete catalogs, twelve complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL/HR/BG), Estonian partial at 2,578/3,768 and seven unauthored catalogs (EL/HU/GA/LV/LT/MT/RO). Remaining UI authoring backlog: 27,566 messages. Estonian twenty-three batches pass all 34 focused tests, types, scoped lint and whitespace. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
