...
Latest authoring checkpoint — 13 September (latest English source 43e885c): four active complete catalogs, ten complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL), Croatian partial at 1,043/3,768 and nine unauthored catalogs. Remaining UI authoring backlog: 36,637 messages. Croatian copy across fifteen batches passes all 26 focused tests, types, scoped lint and whitespace. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
