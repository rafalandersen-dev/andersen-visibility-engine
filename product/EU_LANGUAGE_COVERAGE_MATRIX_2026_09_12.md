...
Latest authoring checkpoint - 13 September (latest English source b68c89e): four active complete catalogs, thirteen complete staged catalogs (FR/DE/ES/IT/PT/NL/FI/CS/SK/SL/HR/BG/ET), Greek partial at 2,578/3,768 and six unauthored catalogs (HU/GA/LV/LT/MT/RO). Remaining UI authoring backlog: 23,798 messages. Greek twenty-three batches pass all 34 focused tests, types, scoped lint, formatting and whitespace. The original audit and incremental history below retain their dated baselines; none constitutes activation or fluent/rendered acceptance.
