...
51 focused tests across three files pass after the evidence addition. New files pass scoped ESLint and whitespace checks. No fluent-speaker, rendered-screen, accessibility or actual locale acceptance is claimed. Workflow is the final remaining authoring group. Do not enable Portuguese before full coverage, reviewed source claims and required quality acceptance.
