...
- [ ] Deliver Milo as Growth Lead with Brand, Search, Content, Visual, SEO, AI Visibility and Performance specialists over existing tools. Share only the correct project context; inspect evidence, research, prepare/update content, check results and explain blockers. Run relevant bounded workflows, with resumable jobs and shared permissions across app, Slack and MCP.
